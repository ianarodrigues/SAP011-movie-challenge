...
describe('MovieContainerComponent', () => {
  ...
  it('should set queryParams when genre and orderBy are provided', () => {
    ...
    component.orderBy = 'popularity.desc';
    component.pageNumber = '1';
    component.ngOnChanges({
      genre: { currentValue: 'Action', previousValue: undefined, isFirstChange: () => true, firstChange: false },
      orderBy: { currentValue: 'popularity.desc', previousValue: undefined, isFirstChange: () => true, firstChange: false },
  ...
  it('should set queryParams when only orderBy is provided', () => {
    component.orderBy = 'vote_average.desc';
    component.ngOnChanges({
      orderBy: { 
        currentValue: 'vote_average.desc', 
        previousValue: undefined, 
        isFirstChange: () => true, 
        firstChange: false 
      }
